...
$sqlFiles = @(
    ...
    '05_billing_db', '06_pharmacy_db', '07_notification_db'
)
...
mysql -u root -e "DROP DATABASE IF EXISTS auth_db; DROP DATABASE IF EXISTS patient_db; DROP DATABASE IF EXISTS doctor_db; DROP DATABASE IF EXISTS appointment_db; DROP DATABASE IF EXISTS billing_db; DROP DATABASE IF EXISTS pharmacy_db; DROP DATABASE IF EXISTS notification_db;"
